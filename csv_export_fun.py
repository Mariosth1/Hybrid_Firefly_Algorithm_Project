def csv_export(alg_runs, name_of_file):
    ...
    from main import fa_iterations, fireflies_pop, dimensions, Algorithm, independent_runs
    import pandas as pd
    ...
    for i in range(alg_runs):
        ...
        [Quality, Position , Exploration, Exploitation
         ] = Algorithm(fa_iterations, fireflies_pop, dimensions).results(i, independent_runs)
